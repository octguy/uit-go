...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x04User\x12E\n" +
	"\fValidateUser\x12\x19.user.ValidateUserRequest\x1a\x1a.user.ValidateUserResponseB\bZ\x06proto/b\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.User.ValidateUser:input_type -> user.ValidateUserRequest
	1, // 1: user.User.ValidateUser:output_type -> user.ValidateUserResponse
