...
('660e8400-e29b-41d4-a716-446655440002', '660e8400-e29b-41d4-a716-446655440012', 'LICENSE-123456', 'Toyota Vios', '51A-12345', 4.5, 150, 'AVAILABLE', 4, extract(epoch from now()) * 1000, extract(epoch from now()) * 1000);
...
('660e8400-e29b-41d4-a716-446655440002', '660e8400-e29b-41d4-a716-446655440002', 10.762622, 106.660172, extract(epoch from now()) * 1000, 'w3gvk1ysj');
...
('760e8400-e29b-41d4-a716-446655440002', '660e8400-e29b-41d4-a716-446655440002', extract(epoch from now()) * 1000 - 1800000, NULL, true, 28.7, 67.25);